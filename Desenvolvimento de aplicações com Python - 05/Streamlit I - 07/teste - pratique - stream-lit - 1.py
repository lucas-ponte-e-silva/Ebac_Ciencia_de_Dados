...
if uploaded_files:
    ...
    # Se nenhum arquivo foi carregado, use um arquivo de exemplo no repositório
    example_path = 'input'
    meses = ['JAN', 'FEV', 'MAR', 'ABR', 'MAI', 'JUN']
    sinasc = pd.concat([pd.read_csv(os.path.join(example_path, f'SINASC_RO_2019_{mes}.csv')) for mes in meses])
